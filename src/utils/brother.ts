...
async function doPrint(printerUrl: any, bufferToBePrinted: any) {
    //@ts-ignore
...
function convertToBlackAndWhiteMatrixImage(image: any, options: any) {
...
function rotateMatrixImage(bwMatrixImage: any) {
    let rows = [];
...
function convertImageToDotlabel(bwMatrixImage: any) {
...
async function convert(img: any, options: any) {
    // get options
    let defaultOptions = {
        landscape: false,
...
module.exports = {
    printPngFile: async function(printerUrl: any, filename: any, options: any) {
        // read PNG file
    ...
    printPngBuffer: async function (printerUrl: any, buffer: any, options: any) {
        // read PNG buffer
